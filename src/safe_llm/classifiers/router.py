...
Run: python -m safe_llm.classifiers.router
"""
...
def write_report(actions: list[dict[str, object]], outputs_dir: Path | None = None) -> Path:
    out_dir = outputs_dir or OUTPUTS
    out_dir.mkdir(parents=True, exist_ok=True)
    path = out_dir / "classifier_report.json"
