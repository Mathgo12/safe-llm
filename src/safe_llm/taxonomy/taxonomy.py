...
stable JSON artifact for the rest of the harness.

Run: python -m safe_llm.taxonomy.taxonomy
"""
...
def write_taxonomy_json(tax: Taxonomy, outputs_dir: Path | None = None) -> Path:
    out_dir = outputs_dir or _ensure_outputs_dir()
