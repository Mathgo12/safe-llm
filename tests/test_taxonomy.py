...
from safe_llm.taxonomy.fixtures import CATEGORIES, fixtures as load_fixtures
from safe_llm.taxonomy.taxonomy import (
    MIN_PER_CATEGORY,
    SEVERITY_RANGE,
    Taxonomy,
    write_taxonomy_json,
...
class TestArtifact(unittest.TestCase):
    ...
    def test_write_artifact_creates_file(self, tmp_dir: Path | None = None) -> None:
        import tempfile
        tax = Taxonomy.from_default()
        with tempfile.TemporaryDirectory() as td:
            path = write_taxonomy_json(tax, outputs_dir=Path(td))
